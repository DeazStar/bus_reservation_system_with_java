...
public class CustomerManagment implements FileStorage {
        ...
        if (userInfo == null) {
            ...
            try {
                ...
                String sql = "SELECT first_name, last_name, date_of_birth, "
                        + "email, phone_number, address_id FROM customer "
                        + "WHERE customer_id = ?";
                ...
                if (result.next()) {
                    ...
                    String addressSql = "SELECT street_address, city, region FROM address "
                            + "WHERE address_id = ?"; // finish it when chatGPT is available 
    ...
    public ArrayList<String> load(String username) {
        ...
        try {
            ...
            String sql = "SELECT customer_id, username, password from customer_management "
                    + "WHERE username = ?";
            statement = connection.prepareStatement(sql);
